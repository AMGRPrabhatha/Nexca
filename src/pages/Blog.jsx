...
const Blog = () => {
  ...
  const articles = [
    ...
    { 
      ...
      category: 'Guides',
      excerpt: 'Nexca provides luxury vehicle sourcing. Here is what you need to know before booking your import...',
    ...
    { 
      ...
      content: `
        ...
        <p>At Nexca Motors, we handle the complexities so you can focus on the excitement of your new arrival. Discover how our end-to-end service ensures you get the best car at the best price.</p>
      `
    },
  ];
