        ...
        <div className="story-section-v2">
          ...
          <div className="story-mid-col">
            <h2 className="story-main-text">
              <span className="text-dark">Tired of standard dealerships? At Nexca Motors, we specialize in sourcing unique, premium Japanese imports that go beyond the ordinary.</span>
          ...
          <div className="story-right-col">
            <img src="/feature-car.webp" alt="Nexca Story" />
          </div>
        </div>
