  ...
  const testimonials = [
    {
      name: "Saman Perera",
      role: "Business Owner",
      text: "The import process was surprisingly smooth. Nexca handled everything from the auction in Japan to the delivery in Colombo. My Land Cruiser arrived in pristine condition.",
      avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&q=80&w=100"
    },
    {
      name: "Anjali de Silva",
      role: "Luxury Car Enthusiast",
      text: "I was looking for a specific Jaguar F-PACE configuration. The team at Nexca found the exact model and handled the inspection with extreme detail. Highly recommended!",
